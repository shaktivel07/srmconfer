                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center">
                    ...
                    <div className="text-white z-10 text-center w-full">
                        <div className="md:space-y-4">
                            <h1 className="text-xl md:text-4xl xl:text-5xl font-bold">International Conference on Quantum Intelligence for Societal Transformation: Shaping the Next Decade</h1>
                        </div>
