            ...
            <div className="flex flex-col justify-center items-center">
                <div className="flex flex-col justify-center gap-12 w-[90%] md:max-w-[70%] overflow-x-auto md:overflow-auto">
                    <div className='space-y-2'>
                        <h2 className="text-xl md:text-2xl font-semibold text-blue-900 pb-4">Day 1 Conference (13th August 2026)</h2>
                    ...
                    <div className='space-y-2'>
                        <h2 className="text-xl md:text-2xl font-semibold text-blue-900 pb-4">Day 2 Conference (14th August 2026)</h2>
                        <table className="w-full border-collapse border border-gray-300">
                            <thead>
                                <tr className="bg-gray-200">
                                    <th className="border border-gray-300 py-2 px-4 text-left">Time</th>
